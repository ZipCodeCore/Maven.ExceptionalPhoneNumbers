...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber[] createRandomPhoneNumberArray(int phoneNumberCount) {
        Stream<PhoneNumber> randomPhoneNumberArray = Stream.generate(PhoneNumberFactory::createRandomPhoneNumber).limit(phoneNumberCount);
        return randomPhoneNumberArray.toArray(PhoneNumber[]::new);
    }
