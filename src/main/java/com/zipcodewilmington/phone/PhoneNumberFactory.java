...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        Logger logger = Logger.getLogger(PhoneNumberFactory.class.getName());
        String phoneNumebrString = "(" + areaCode + ")-" + centralOfficeCode + "-" + phoneLineCode;
        try {
            return createPhoneNumber(phoneNumebrString);
        } catch (InvalidPhoneNumberFormatException e) {
            logger.warning(phoneNumebrString + "is not a valid phone number");
            return null;
        }
    }
